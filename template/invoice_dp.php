...
<head>
<meta charset="utf-8">
<title>Invoice DP - <?= htmlspecialchars($proyek['no_inv_dp']) ?></title>
...
<h1>INVOICE DOWN PAYMENT (DP)</h1>

<p style="margin-bottom:4px"><strong>No:</strong> <?= htmlspecialchars($proyek['no_inv_dp'] ?: '-') ?></p>
...
<p style="margin-top:10px;margin-bottom:10px">
  Dengan hormat,<br>
  Mohon pembayaran <strong>Uang Muka (DP)</strong> sebesar <?= $dp_persen ?>% dari nilai proyek untuk:
</p>
...
<div class="info-box">
  ...
  <p><strong>DP (<?= $dp_persen ?>%):</strong> <?= rupiah($dp_nominal) ?></p>
</div>

<p style="font-style:italic;margin-bottom:10px"># Terbilang: <?= terbilang($dp_nominal) ?> #</p>

<table style="width:auto;margin-left:auto">
  <tr><td style="border:none;font-weight:600">DP (<?= $dp_persen ?>%)</td><td style="border:none;text-align:right;font-weight:700;font-size:13pt"><?= rupiah($dp_nominal) ?></td></tr>
</table>
