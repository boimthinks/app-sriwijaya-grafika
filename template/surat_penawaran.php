...
<head>
<meta charset="utf-8">
<title>Surat Penawaran - <?= htmlspecialchars($proyek['no_sp']) ?></title>
...
<p style="margin-bottom:4px"><strong>No:</strong> <?= htmlspecialchars($proyek['no_sp'] ?: '-') ?></p>
<p style="margin-bottom:4px"><strong>Lampiran:</strong> -</p>
<p style="margin-bottom:10px"><strong>Kepada Yth:</strong> <?= htmlspecialchars($proyek['nama_perusahaan']) ?></p>

<p style="margin-bottom:10px">Dengan hormat,<br>
Bersama surat ini kami mengajukan penawaran harga untuk barang/jasa sebagai berikut:</p>
...
<div class="terbilang"># <?= terbilang($proyek['grand_total']) ?> #</div>

<p style="margin-top:10px;font-size:10pt">
  <strong>Berlaku sampai:</strong> <?= $proyek['berlaku_sampai'] ? date('d/m/Y', strtotime($proyek['berlaku_sampai'])) : '-' ?>
</p>
